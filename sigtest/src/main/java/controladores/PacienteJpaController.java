...
public class PacienteJpaController implements Serializable {
    ...
    public void create(Paciente paciente) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findPaciente(paciente.getCodPaciente()) != null) {
    ...
    public void edit(Paciente paciente) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                String id = paciente.getCodPaciente();
    ...
    public Paciente busPaciente(Paciente id) {
        EntityManager em = emf.createEntityManager();
        Query con= em.createQuery("SELECT a FROM Paciente a WHERE a.codPaciente=:id");
        con.setParameter("id",id.getCodPaciente());
   
        List<Paciente> cat= con.getResultList();
        return cat.get(0);
    } 
